...
export function InteractiveMentalCompass() {
  ...
  return (
    <section data-sync-section="home-direction" className="py-20 sm:py-24 md:py-32 bg-gradient-to-br from-teal-50 via-blue-50 to-purple-50 relative overflow-hidden flex items-center">
